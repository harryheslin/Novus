...
namespace Novus.Data
{
    class Datastore
    {
        ...
        public static ObservableCollection<Unit> GenerateAllUnits()
        {
            ...
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Week3_lecture_slides.pdf");
            resourcesFiles.Add("Week3_tutorial_slides.pdf");
            resources.Add(new Resources("Week 3", resourcesFiles, "Week 3 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Week4_lecture_slides.pdf");
            resourcesFiles.Add("Week4_tutorial_slides.pdf");
            resources.Add(new Resources("Week 4", resourcesFiles, "Week 4 Lecture"));
            ...
            assesment.Add(new Assesment("IFB103", "Application Design - Assignment 1", 40, new DateTime(2020, 02, 20, 12, 35, 10).ToShortDateString(), new DateTime(2020, 03, 14, 12, 0, 0).ToShortDateString(), true, new DateTime(2020, 03, 19, 12, 0, 0).ToShortDateString(), "28.5/30", "true"));
            assesment.Add(new Assesment("IFB103", "Application Prototypes - Assignment 2", 40, new DateTime(2020, 03, 01, 12, 0, 0).ToShortDateString(), new DateTime(2020, 04, 12, 12, 0, 0).ToShortDateString(), false, "TBC", "0", "true"));
            assesment.Add(new Assesment("IFB103", "Final Exam", 20, "TBC", "TBC", false, "TBC", "0", "false"));
            resourcesFiles.Add("Week1_lecture_slides.pdf");
            resourcesFiles.Add("Week1_tutorial_slides.pdf");
            resourcesFiles.Add("1_Worksheet.pdf");
            resourcesFiles.Add("1_worksheet_solution.pdf");
            resourcesFiles.Add("IFB103_Outline.pdf");
            resourcesFiles.Add("AssesmentOverview.pdf");
            resources.Add(new Resources("Week 1", resourcesFiles, "Week 1 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Week2_lecture_slides.pdf");
            resourcesFiles.Add("Week2_tutorial_slides.pdf");
            resourcesFiles.Add("2_Worksheet.pdf");
            resourcesFiles.Add("2_worksheet_solution.pdf");
            resources.Add(new Resources("Week 2", resourcesFiles, "Week 2 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Week3_lecture_slides.pdf");
            resourcesFiles.Add("Week3_tutorial_slides.pdf");
            resourcesFiles.Add("3_Worksheet.pdf");
            resourcesFiles.Add("3_worksheet_solution.pdf");
            resources.Add(new Resources("Week 3", resourcesFiles, "Week 3 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Week4_lecture_slides.pdf");
            resourcesFiles.Add("Week4_tutorial_slides.pdf");
            resourcesFiles.Add("4_worksheet.pdf");
            resources.Add(new Resources("Week 4", resourcesFiles, "Week 4 Lecture"));
            ...
            announcements.Add(new Announcement("IFB105", "Practical 2 Grades", "Grades for the second practical have now been made available. Please email your tutor for any concerns you may have with your grade or the provided feedback.", new DateTime(2020, 03, 22, 11, 34, 43), "Robert Andrews"));
            announcements.Add(new Announcement("IFB105", "Practical 2 Released", "Hello students, the second practical assesment has now been released. This is based on content delivered through weeks 3 and 4.", new DateTime(2020, 03, 22, 11, 34, 43), "Robert Andrews"));
            announcements.Add(new Announcement("IFB105", "Practical 1 Grades", "Grades for the first practical have now been made available. Please email your tutor for any concerns you may have with your grade or the provided feedback.", new DateTime(2020, 03, 03, 11, 34, 43), "Robert Andrews"));
            announcements.Add(new Announcement("IFB105", "Practical 1 Released", "Hello students, the first practical assesment of this unit has been released. The task is based on the content taught throughout weeks 1-2. Please take any questions to your tutorial or post on the #practical slack channel", new DateTime(2020, 02, 28, 11, 34, 43), "Robert Andrews"));
            announcements.Add(new Announcement("IFB105", "IFB105 - Week 1", "Welcome to week 1 of IFB105. This unit will give you an in depth introduction to databases, different types of modelling techniques and SQL. Tutorials will begin in week 2, please make sure you have watched the week 1 lecture prior to attending.", new DateTime(2020, 02, 14, 11, 34, 43), "Robert Andrews"));
            assesment.Add(new Assesment("IFB105", "Practical 1 - ORM Part 1", 15, new DateTime(2020, 02, 21, 12, 35, 10).ToShortDateString(), new DateTime(2020, 03, 01, 12, 0, 0).ToShortDateString(), true, new DateTime(2020, 03, 03, 12, 0, 0).ToShortDateString(), "13/15", "true"));
            assesment.Add(new Assesment("IFB105", "Practical 2 - ORM Part 2", 15, new DateTime(2020, 03, 05, 12, 0, 0).ToShortDateString(), new DateTime(2020, 03, 22, 12, 0, 0).ToShortDateString(), true, new DateTime(2020, 04, 01, 12, 0, 0).ToShortDateString(), "14/15", "true"));
            assesment.Add(new Assesment("IFB105", "Practical 3 - SQL Part 1", 15, "TBC", "TBC", false, "TBC", "0", "false"));
            assesment.Add(new Assesment("IFB105", "Practical 3 - SQL Part 2", 15, "TBC", "TBC", false, "TBC", "0", "false"));
            assesment.Add(new Assesment("IFB105", "Final Exam", 40, "TBC", "TBC", false, "TBC", "0", "false"));
            resourcesFiles.Add("Lecture-1-Slides.pdf");
            resourcesFiles.Add("Tutorial-1-Slides.pdf");
            resourcesFiles.Add("Staff-Contact-Details.pdf");
            resourcesFiles.Add("Getting-Started.pdf");
            resources.Add(new Resources("Week 1", resourcesFiles, "Week 1 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture-2-Slides.pdf");
            resourcesFiles.Add("Tutorial-2-Slides.pdf");
            resources.Add(new Resources("Week 2", resourcesFiles, "Week 2 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture-3-Slides.pdf");
            resourcesFiles.Add("Tutorial-3-Slides.pdf");
            resources.Add(new Resources("Week 3", resourcesFiles, "Week 3 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture-4-Slides.pdf");
            resourcesFiles.Add("Tutorial-4-Slides.pdf");
            resources.Add(new Resources("Week 4", resourcesFiles, "Week 4 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture-5-Slides.pdf");
            resourcesFiles.Add("Tutorial-5-Slides.pdf");
            resources.Add(new Resources("Week 5", resourcesFiles, "Week 5 Lecture"));
            ...
            announcements.Add(new Announcement("IFB104", "Assignment 1 Info Session", "An information session regarding assignment 1 will be taking place today in room Z-514. ", new DateTime(2020, 03, 04, 14, 56, 21), "Alistair Barros"));
            ...
            assesment.Add(new Assesment("IFB104", "If Statement Assignment", 20, new DateTime(2020, 03, 15, 12, 0, 0).ToShortDateString(), new DateTime(2020, 04, 22, 12, 0, 0).ToShortDateString(), false, "TBC", "0", "true"));
            assesment.Add(new Assesment("IFB104", "Midsem Exam - For Loops", 30, "N/A", new DateTime(2020, 04, 30, 12, 0, 0).ToShortDateString(), false, "TBC", "0", "false"));
            assesment.Add(new Assesment("IFB104", "For Loop Assignment", 20, "TBC", "TBC", false, "TBC", "0", "false"));
            assesment.Add(new Assesment("IFB104", "Final Exam", 30, "TBC", "TBC", false, "TBC", "0", "false"));
            resourcesFiles.Add("Lecture1.pdf");
            resourcesFiles.Add("Workshop1.pdf");
            resourcesFiles.Add("Python_Introduction.pdf");
            resourcesFiles.Add("Getting_Started.pdf");
            resourcesFiles.Add("Useful_Readings.pdf");
            resources.Add(new Resources("Week 1", resourcesFiles, "Week 1 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture2.pdf");
            resourcesFiles.Add("Workshop2.pdf");
            resourcesFiles.Add("Worksheet1.pdf");
            resourcesFiles.Add("WorksheetSolutions1.pdf");
            resources.Add(new Resources("Week 2", resourcesFiles, "Week 2 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture3.pdf");
            resourcesFiles.Add("Workshop3.pdf");
            resourcesFiles.Add("Worksheet2.pdf");
            resourcesFiles.Add("WorksheetSolutions2.pdf");
            resources.Add(new Resources("Week 3", resourcesFiles, "Week 3 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture4.pdf");
            resourcesFiles.Add("Workshop4.pdf");
            resourcesFiles.Add("Worksheet3.pdf");
            resourcesFiles.Add("WorksheetSolutions3.pdf");
            resources.Add(new Resources("Week 4", resourcesFiles, "Week 4 Lecture"));
            resourcesFiles = new ObservableCollection<string>();
            resourcesFiles.Add("Lecture5.pdf");
            resourcesFiles.Add("Workshop5.pdf");
            resourcesFiles.Add("Worksheet4.pdf");
            resources.Add(new Resources("Week 5", resourcesFiles, "Week 5 Lecture"));
