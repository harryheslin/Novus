...
namespace Novus.Data
{
    class Datastore
    {
        ...
        public static ObservableCollection<Unit> GenerateAllUnits()
        {
            ...
            Unit IFB105 = new Unit("IFB105", "Database Management", information, "#A1F1F4", announcements, assesment);
            units.Add(IFB105);
            ...
            Unit IFB104 = new Unit("IFB104", "Building IT Systems", information, "#EFE379", announcements, assesment);
            units.Add(IFB104);
            ...
            Unit CAB201 = new Unit("CAB201", "Programming Principles", information, "#E1AAEC", announcements, assesment);
            units.Add(CAB201);
            ...
            Unit CAB202 = new Unit("CAB202", "Microprocessors and Digital Systems", information, "#AAECDE", announcements, assesment);
            units.Add(CAB202);
            ...
            Unit CAB203 = new Unit("CAB203", "Discrete Structures", information, "#CD9864", announcements, assesment);
            units.Add(CAB203);
            ...
            Unit CAB302 = new Unit("CAB302", "Software Development", information, "#BDD647", announcements, assesment);
            units.Add(CAB302);
            ...
            Unit CAB303 = new Unit("CAB303", "Networks", information, "#80EE8B", announcements, assesment);
            units.Add(CAB303);
            ...
            Unit IFB295 = new Unit("IFB295", "IT Project Management", information, "#F3B15B", announcements, assesment);
            units.Add(IFB295);
            ...
            Unit CAB301 = new Unit("CAB301", "Algorithms and Complexity", information, "#A1F1F4", announcements, assesment);
            units.Add(CAB301);
            ...
            Unit IFB398 = new Unit("IFB398", "Capstone Project (Phase 1)", information, "#EFE379", announcements, assesment);
            units.Add(IFB398);
            ...
            Unit CAB402 = new Unit("CAB402", "Programming Paradigms", information, "#E1AAEC", announcements, assesment);
            units.Add(CAB402);
            ...
            Unit CAB420 = new Unit("CAB420", "Machine Learning", information, "#AAECDE", announcements, assesment);
            units.Add(CAB420);
            ...
            Unit IFB399 = new Unit("IFB399", "Capstone Project (Phase 2)", information, "#CD9864", announcements, assesment);
            units.Add(IFB399);
            ...
            Unit CAB401 = new Unit("CAB401", "High Performance and Parallel Computing", information, "#BDD647", announcements, assesment);
            units.Add(CAB401);
            ...
            Unit CAB403 = new Unit("CAB403", "Systems Programming", information, "#80EE8B", announcements, assesment);
            units.Add(CAB403);
            ...
            Unit IAB201 = new Unit("IAB201", "Modelling Techniques for Information Systems", information, "#F3B15B", announcements, assesment);
            units.Add(IAB201);
            ...
            Unit IAB207 = new Unit("IAB207", "Rapid Web Application Development", information, "#A1F1F4", announcements, assesment);
            units.Add(IAB207);
            ...
            Unit IAB203 = new Unit("IAB203", "Business Process Modelling", information, "#EFE379", announcements, assesment);
            units.Add(IAB203);
            ...
            Unit IAB204 = new Unit("IAB204", "Business Requirements Analysis", information, "#E1AAEC", announcements, assesment);
            units.Add(IAB204);
            ...
            Unit IAB305 = new Unit("IAB305", "Information Systems Lifecycle Management", information, "#AAECDE", announcements, assesment);
            units.Add(IAB305);
            ...
            Unit IAB206 = new Unit("IAB206", "Modern Data Management", information, "#CD9864", announcements, assesment);
            units.Add(IAB206);
            ...
            Unit IAB320 = new Unit("IAB320", "Business Process Improvement", information, "#BDD647", announcements, assesment);
            units.Add(IAB320);
            ...
            Unit IAB303 = new Unit("IAB303", "Data Analytics for Business Insight", information, "#A1F1F4", announcements, assesment);
            units.Add(IAB303);
            ...
            Unit IAB260 = new Unit("IAB260", "Social Technologies", information, "#80EE8B", announcements, assesment);
            units.Add(IAB260);
            ...
            Unit IAB402 = new Unit("IAB402", "Information Systems Consulting", information, "#F3B15B", announcements, assesment);
            units.Add(IAB402);
            ...
            Unit IAB401 = new Unit("IAB401", "Enterprise Architecture", information, "#A1F1F4", announcements, assesment);
            units.Add(IAB401);
            ...
            Unit MXB100 = new Unit("IAB401", "Introductory Calculus and Algebra", information, "#EFE379", announcements, assesment);
            units.Add(MXB100);
            ...
            Unit MXB103 = new Unit("MXB103", "Introductory Computational Mathematics", information, "#E1AAEC", announcements, assesment);
            units.Add(MXB103);
            ...
            Unit MXB161 = new Unit("MXB161", "Computational Explorations", information, "#AAECDE", announcements, assesment);
            units.Add(MXB161);
            ...
            Unit MXB261 = new Unit("MXB261", "Modelling and Simulation Science", information, "#CD9864", announcements, assesment);
            units.Add(MXB261);
            ...
            Unit MXB262 = new Unit("MXB262", "Visualising Data", information, "#BDD647", announcements, assesment);
            units.Add(MXB262);
            ...
            Unit MXB361 = new Unit("MXB361", "Aspects of Computational Science", information, "#A1F1F4", announcements, assesment);
            units.Add(MXB361);
            ...
            Unit MXB362 = new Unit("MXB362", "Advanced Visualisation and Data Science", information, "#80EE8B", announcements, assesment);
            units.Add(MXB362);
            ...
            Unit MXB101 = new Unit("MXB101", "Probability and Stochastic Modelling 1", information, "#F3B15B", announcements, assesment);
            units.Add(MXB101);
            ...
            Unit MXB107 = new Unit("MXB107", "Introduction to Statistical Modelling", information, "#A1F1F4", announcements, assesment);
            units.Add(MXB107);
            ...
            Unit MZB151 = new Unit("MZB151", "Mathematical Tools for Computing", information, "#EFE379", announcements, assesment);
            units.Add(MZB151);
            ...
            Unit CAB220 = new Unit("CAB220", "Fundamentals of Data Science", information, "#E1AAEC", announcements, assesment);
            units.Add(CAB220);
            ...
            Unit BSB123 = new Unit("BSB123", "Data Analysis", information, "#AAECDE", announcements, assesment);
            units.Add(BSB123);
            ...
            Unit CAB330 = new Unit("CAB330", "Data and Web Analytics", information, "#CD9864", announcements, assesment);
            units.Add(CAB330);
            ...
            Unit IAB321 = new Unit("IAB321", "Business Process Technologies", information, "#BDD647", announcements, assesment);
            units.Add(IAB321);
            ...
            Unit IAB250 = new Unit("IAB250", "Enterprise Systems Configuration", information, "#A1F1F4", announcements, assesment);
            units.Add(IAB250);
            ...
            Unit IAB351 = new Unit("IAB351", "Business in the Cloud", information, "#80EE8B", announcements, assesment);
            units.Add(IAB351);
            ...
            Unit IAB352 = new Unit("IAB352", "Enterprise Systems Mangement", information, "#F3B15B", announcements, assesment);
            units.Add(IAB352);
            ...
            Unit BSB115 = new Unit("BSB115", "Management", information, "#A1F1F4", announcements, assesment);
            units.Add(BSB115);
            ...
            Unit IAB230 = new Unit("IAB230", "Design of Enterprise IoT", information, "#EFE379", announcements, assesment);
            units.Add(IAB230);
            ...
            Unit CAB320 = new Unit("CAB320", "Artificial Intelligence", information, "#E1AAEC", announcements, assesment);
            units.Add(CAB320);
            ...
            Unit EGB339 = new Unit("EGB339", "Introduction to Robotics", information, "#AAECDE", announcements, assesment);
            units.Add(EGB339);
            ...
            Unit IAB330 = new Unit("IAB330", "Mobile Application Development", information, "#CD9864", announcements, assesment);
            units.Add(IAB330);
            ...
            Unit CAB230 = new Unit("CAB230", "Web Computing", information, "#BDD647", announcements, assesment);
            units.Add(CAB230);
            ...
            Unit CAB240 = new Unit("CAB240", "Information Security", information, "#80EE8B", announcements, assesment);
            units.Add(CAB240);
            ...
            Unit CAB432 = new Unit("CAB432", "Cloud Computing", information, "#F3B15B", announcements, assesment);
            units.Add(CAB432);
